...
module AttachmentPatch
  ...
  module InstanceMethods
    ...
    def save_attachments_with_pasted_images(attachments, author=User.current)
      # CHANGE attachments is not a Hash but ActionController::Parameters type
      if attachments && attachments.class == ActionController::Parameters #&& attachments.is_a?(Hash)
